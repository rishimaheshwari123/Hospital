...
const Review = () => {
  const testimonials = [
    {
      id: 1,
      text: "Orlando made it incredibly easy to find the right doctor. The entire experience—from booking to consultation—was seamless and stress-free.",
      author: "Emily Johnson",
    },
    {
      id: 2,
      text: "I found a nearby clinic through Orlando and received excellent care. The staff was friendly and the whole process was quick and simple.",
      author: "Michael Thompson",
    },
    {
      id: 3,
      text: "The team at Orlando was professional and truly caring. They guided me through every step of my treatment with clear communication and compassion.",
  ...
  return (
    <div className="w-full bg-gray-50 py-16 px-4 overflow-hidden">
      <div className="max-w-6xl mx-auto relative">
        <h1 className="uppercase text-3xl text-[#00a0aa] font-bold text-center">
