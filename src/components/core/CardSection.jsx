...
const services = [
  {
    ...
    icon: (
      <FaHeartbeat className="text-red-500 group-hover:text-red-700 text-3xl transition-all duration-300" />
    ),
  ...
  },
  {
    ...
    icon: (
      <FaStethoscope className="text-blue-500 group-hover:text-blue-700 text-3xl transition-all duration-300" />
    ),
  ...
  },
  {
    ...
    icon: (
      <FaLaptopMedical className="text-green-500 group-hover:text-green-700 text-3xl transition-all duration-300" />
    ),
  ...
  return (
    <div className="max-w-6xl mx-auto p-8 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      {services.map((service, index) => (
        ...
        >
          <div className="absolute top-1 right-2 bg-white p-3 rounded-full shadow-md group-hover:scale-110 transition-transform duration-300">
            {service.icon}
          </div>
